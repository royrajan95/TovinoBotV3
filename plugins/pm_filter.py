            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton('🙅🏽‍♂️ᴄʟᴏsᴇ', callback_data='close')
                    ]
                ]
            )
        )
